...
import time
from cultivar_maandelijks_modules.log import log
from cultivar_maandelijks_modules.database import connect_to_database, write_to_database, clear_table
from cultivar_maandelijks_modules.config import fetch_configurations, fetch_script_id, fetch_all_connection_strings
from cultivar_maandelijks_modules.table_mapping import transform_columns, partij_maat_details, fust_details
from cultivar_maandelijks_modules.type_mapping import convert_column_types, partij_maat_typing, fust_typing
from cultivar_maandelijks_modules.column_selection import select_columns, partij_maat_columns, fust_columns
from cultivar_maandelijks_modules.get_request import get_request
import logging 
        ...
        if klantnaam == "Borst Bloembollen":
            ...
            for bron, dict in configuratie_dict.items():
                if bron == 'Bulbmanager | Azure SQL Database':
                    ...
                    eerste_jaar = 2013
                    # Range maken tussen eerste jaar en twee jaar terug
