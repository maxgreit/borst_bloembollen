from empl_modules.config import determine_script_id, create_connection_dict, create_config_dict, retrieve_token_url_system
from empl_modules.column_selection import apply_column_selection, alter_columns
from empl_modules.get_request import execute_get_request
from empl_modules.database import empty_and_fill_table
from empl_modules.type_mapping import apply_conversion
from empl_modules.table_mapping import apply_mapping
from empl_modules.env_tool import env_check
from empl_modules.log import log, end_log
import logging
import time
import os
...
def main():
    ...
    script = "Dyflexis | Werknemers | Wekelijks"
    bron = 'Python'
