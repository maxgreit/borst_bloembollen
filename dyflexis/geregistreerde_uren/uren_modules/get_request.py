...
def get_request(tabelnaam, start_date, end_date, base_url, endpoint, token, system_name):
    total_rows = 0
...
def execute_get_request(base_url, token, system_name, tabelnaam, endpoint, start_date, end_date):
    try:
        df = get_request(tabelnaam, start_date, end_date, base_url, endpoint, token, system_name)
    except Exception as e:
