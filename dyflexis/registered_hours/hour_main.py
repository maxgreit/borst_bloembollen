from hour_modules.config import determine_script_id, create_connection_dict, create_config_dict, retrieve_token_url_system
from hour_modules.column_selection import apply_column_selection, add_calculated_columns, alter_columns
from hour_modules.year_determination import this_year, last_year
from hour_modules.get_request import execute_get_request
from hour_modules.database import empty_and_fill_table
from hour_modules.type_mapping import apply_conversion
from hour_modules.table_mapping import apply_mapping
from hour_modules.env_tool import env_check
from hour_modules.log import log, end_log
import logging
import time
import os

def main(datum_range):
    ...
    script = "Dyflexis | Geregistreerde Uren | Dagelijks"
    bron = 'Python'
